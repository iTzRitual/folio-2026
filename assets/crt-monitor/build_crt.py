...
loft('CRT_Bezel',[ (.412,.308,.007,0,.036),(.409,.305,.007,0,.038),(.403,.299,.009,0,.034),(.376,.279,.016,0,-.013),(.365,.274,.018,0,-.022),(.361,.270,.018,0,-.026)],black)
...
for k in range(17):
    t=k/16
    for x,y in outline(.352+.012*t,.264+.010*t,.0002+.008*t,n=32):
