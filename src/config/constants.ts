...
export const CONFIG = {
    ...
    pointerCamera: {
        ENABLED: true,
        HORIZONTAL_STRENGTH: 0.25,
        VERTICAL_STRENGTH: 0.125,
        FOCUS_DEPTH: 0.5,
        REFERENCE_FOV: 26.5,
    ...
    workstation: {
        ...
        TURNTABLE_POSITION: { x: 0.13, y: 0, z: 0.025 },
        TURNTABLE_ROTATION: { x: 0, y: -3, z: 0 },
        TURNTABLE_SCALE: 1,
        DESK_MODEL_URL: "/glbs/workstation-desk.glb",
        KEYBOARD_POSITION: { x: 0.055, y: 0, z: 0.19 },
        KEYBOARD_ROTATION: { x: 0, y: -2, z: 0 },
        KEYBOARD_SCALE: 1,
        DESK_POSITION: { x: 0, y: 0, z: -0.12 },
        DESK_SCALE: { x: 1.37, y: 1.6, z: 0.91 },
        MONITOR_POSITION: { x: 0.055, y: 0, z: -0.055 },
        MONITOR_YAW: -6,
        CABINET_POSITION: { x: -1.101, y: 0.225, z: -0.35 },
        CABINET_SIZE: { x: 0.882, y: 0.945, z: 0.53 },
        CABINET_PANEL: 0.024,
        CABINET_PLINTH: 0.063,
        MOUSE_POSITION: { x: 0.3, y: 0, z: 0.19 },
        CONTROLLER_POSITION: { x: -0.32, y: 0, z: 0.13 },
        LAMP_SCALE: 0.78,
        LAMP_POSITION: { x: -0.255, y: 0, z: -0.06 },
        WINDOW_POSITION: { x: -0.96, y: 0.8, z: -0.69 },
        WINDOW_SIZE: { x: 0.86, y: 0.95, z: 0.08 },
        POSTER_POSITION: { x: 0.92, y: 0.58, z: -0.62 },
        SKATEBOARD_POSITION: { x: 0.17, y: 0.69, z: -0.59 },
        PLANT_POSITION: { x: -1.22, y: 0.34, z: -0.61 },
        CAMERA_END: { x: -0.02, y: 0.53, z: 1.5 },
        CAMERA_TARGET: { x: -0.02, y: 0.27, z: -0.14 },
        CAMERA_FINAL_FOV: 42,
        SKATEBOARD_SIZE: { width: 0.2032, length: 0.805, thickness: 0.018 },
        POSTER_SIZE: { x: 0.52, y: 0.82 },
        POLAROIDS_POSITION: { x: -0.43, y: 0.63, z: -0.615 },
        FLOOR_PLANT_POSITION: { x: 0.99, y: -0.72, z: -0.4 },
        FLOOR_PLANT_SPREAD: 0.48,
        FLOOR_PLANT_LEAF_SCALE: 0.72,
        FLOOR_PLANT_LEAF_VARIATION: 0.12,
        FLOOR_PLANT_LEAF_STEP: 0.09,
        ENERGY_CAN_POSITION: { x: 0.46, y: 0, z: 0.02 },
        LEFT_SPEAKER_POSITION: { x: -0.47, y: 0, z: -0.42 },
        RIGHT_SPEAKER_POSITION: { x: 0.51, y: 0, z: -0.39 },
        ...
        CAMERA_NARROW_WIDTH: 0.76,
        PROXY_YAW: { mouse: -5, controller: 17, poster: 0, skateboard: -90 },
