...
export const CONFIG = {
    ...
    phase2: {
        ...
        CRT_INNER_BORDER_WIDTH: 0.009,
        CRT_INNER_BORDER_BEVEL: 0.0007,
        CRT_INNER_BORDER_RECESS: 0.006,
        CRT_BORDER_SEGMENTS: 8,
        CRT_BORDER_COLOR: "#080b0e",
        CRT_BORDER_ROUGHNESS: 0.34,
        CRT_BORDER_CLEARCOAT: 0.25,
        CRT_BORDER_CLEARCOAT_ROUGHNESS: 0.45,
        CRT_BORDER_SPECULAR_INTENSITY: 0.18,
        CRT_BORDER_ENV_INTENSITY: 0.3,
        CRT_MORPH_END: 0.45,
        CRT_BARREL: 0.012,
        CRT_BORDER: 0.003,
        CRT_EDGE_SOFTNESS: 0.004,
        CRT_VIGNETTE: 0.16,
        CRT_SCANLINES: 480,
        CRT_SCANLINE_STRENGTH: 0.045,
        CRT_PHOSPHOR_STRENGTH: 0.018,
        CRT_CHROMATIC: 0.00035,
        CRT_NOISE: 0.0015,
        CRT_GLOW: 0.055,
        CRT_REFLECTION: 0.035,
        CRT_TARGET_MAX_SIZE: 2048,
        ...
        DOCK_MAGNIFICATION_TOTAL_MULT: 2,
        DOCK_MAGNIFICATION_RESPONSE: 18,
        DOCK_RUNNING_DOT_RADIUS_MULT: 0.023,
        DOCK_RUNNING_DOT_BOTTOM_MULT: 0.055,
        DOCK_SCALE: 0.6,
        DOCK_OFFSET_X: 0,
        DOCK_OFFSET_Y: 0.025,
        SAFARI_CHROME_SCALE: 0.8,
        SAFARI_CONTROLS_SCALE: 0.88,
        SAFARI_ADDRESS_SCALE: 1.2,
        SAFARI_BOTTOM_SAFE_AREA: 0.012,
        ...
        BROWSER_LIGHTS: ["#ff5f57", "#febc2e"] as const,
        GENIE_DURATION: 0.68,
        GENIE_RESTORE_DURATION: 0.56,
        GENIE_REDUCED_DURATION: 0.16,
        GENIE_ROW_STAGGER: 0.78,
        GENIE_TARGET_SCALE_MULT: 0.72,
        RETURN_BRIDGE_REVEAL_BREAKPOINT: 0.32,
        RETURN_BRIDGE_APP_SCROLL_SPAN: 0.48,
        RETURN_BRIDGE_AUTO_SCROLL_DELAY: 0.18,
        RETURN_BRIDGE_AUTO_SCROLL_MIN_SPEED: 260,
        RETURN_BRIDGE_AUTO_SCROLL_DURATION: 1.04,
        RETURN_BRIDGE_AUTO_SCROLL_REDUCED_DURATION: 0.16,
        VSCODE_SCROLLBAR_THICKNESS_MULT: 0.055,
        VSCODE_SCROLLBAR_HIT_MULT: 0.55,
        VSCODE_SCROLLBAR_MIN_THUMB_MULT: 0.42,
        VSCODE_SCROLLBAR_IDLE_ALPHA: 0.38,
        VSCODE_SCROLLBAR_HOVER_ALPHA: 0.68,
        VSCODE_SCROLLBAR_ACTIVE_ALPHA: 0.88,
        VSCODE_SOURCE_REFRESH_MS: 1000,
    },
    loader: {
        REVEAL_DURATION: 0.5,
        ODOMETER_DURATION: 2,
