...
export const CONFIG = {
    ...
    workstation: {
        ...
        MONITOR_YAW: -6,
        CABINET_POSITION: { x: -0.94, y: -0.065, z: -0.2 },
        CABINET_SIZE: { x: 0.53, y: 0.655, z: 0.53 },
        MOUSE_POSITION: { x: 0.3, y: 0, z: 0.19 },
        CONTROLLER_POSITION: { x: -0.32, y: 0, z: 0.13 },
        LAMP_POSITION: { x: 0.55, y: 0, z: -0.27 },
        WINDOW_POSITION: { x: -0.95, y: 0.8, z: -0.69 },
        WINDOW_SIZE: { x: 0.68, y: 0.78, z: 0.08 },
        POSTER_POSITION: { x: -0.38, y: 0.7, z: -0.62 },
        SKATEBOARD_POSITION: { x: 0.92, y: 0.82, z: -0.59 },
        PLANT_POSITION: { x: -1.19, y: 0.425, z: -0.61 },
        CAMERA_END: { x: -0.22, y: 0.62, z: 1.3 },
        CAMERA_TARGET: { x: -0.22, y: 0.21, z: -0.14 },
        CAMERA_CURVE: { x: 0.035, y: 0.05, z: 0.1 },
        CAMERA_ARC_START: 0.18,
        CAMERA_NARROW_WIDTH: 0.76,
        PROXY_YAW: { mouse: -5, controller: 17, poster: -1.4, skateboard: -8 },
        ...
        LIGHTING_MODE: "day" as "day" | "night",
        WINDOW_LIGHT: 1.4,
        LAMP_LIGHT: 2.8,
        FILL_LIGHT: 0.35,
