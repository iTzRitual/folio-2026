...
export const CONFIG = {
  heroAssembly: {
    ...
    FADE_END: 0.88,
    SPIN_TURNS: 1.8,
    ORBIT_ACCEL_START: 0.18,
    ORBIT_ACCEL_TURNS: 2.4,
    ORBIT_EXPAND_START: 0.12,
    ORBIT_EXPAND_END: 0.62,
    ORBIT_GAP_FILL: 0.72,
    ORBIT_MAX_SCALE: 3,
    ORBIT_FADE_START: 0.82,
    ORBIT_FADE_END: 0.9,
    EXIT_SCALE: 0.88,
    UP_TRAVEL: 0.08,
    MODEL_GAP_PADDING_PX: 16,
    MODEL_GAP_FILL: 0.9,
    EXIT_RISE_START: 0.55,
    EXIT_RISE: 0.14,
    SCATTER_DISTANCE: 0.85,
    SCATTER_SWIRL: 0.35,
    SCATTER_SWIRL_NOISE: 0.2,
  ...
  projectOrbit: {
    ...
    SEGMENTS: 48,
    SPEED: -0.11,
    IDLE_MAX_FRAME_DELTA: 0.1,
    DIRECTION_EPSILON: 0.0000001,
    DRAG: {
      MIN_PIXELS_PER_RADIAN: 80,
      VELOCITY_WINDOW_MS: 90,
      RELEASE_TIMEOUT_MS: 120,
      MAX_SPEED: 8,
      FLING_THRESHOLD: 0.4,
      FRICTION: 1.6,
      IDLE_RESPONSE: 6,
    ...
    HUD: {
      ...
      PRIMARY: "#ff405c",
      SECONDARY: "#78e6df",
      PRIMARY_LINEAR: [1.0, 0.05, 0.11],
      SECONDARY_LINEAR: [0.19, 0.79, 0.74],
      PANEL_OPACITY: 0.12,
      VIDEO_BRIGHTNESS: 0.8,
      GLOW_SCALE: 0.4,
    },
    HOLOGRAM_GRAZING_START: 0.04,
    HOLOGRAM_GRAZING_END: 0.24,
    HOLOGRAM_GLOW_WIDTH: 0.045,
    HOLOGRAM_BLEED: 0.22,
    HOLOGRAM_GLOW_FADE_START: 0.12,
    HOLOGRAM_GLOW_FADE_END: 0.2,
    LIGHT_REACH: 0.65,
    OCCLUSION_REACH: 0.45,
    LIGHT_COLOR_TOP: [0.38, 0.9, 1.0],
    LIGHT_COLOR_BOTTOM: [0.8, 0.65, 1.0],
    HOLOGRAM_FADE_START: 0.55,
    HOLOGRAM_DEPTH_FADE: 0.2,
    HOLOGRAM_SCAN_LINES: 72,
    HOLOGRAM_SCAN_STRENGTH: 0.035,
    HOLOGRAM_SCAN_SPEED: 0.06,
    ENTRANCE_START: 0.1,
    ENTRANCE_DURATION: 1.35,
    ENTRANCE_CRUISE_DURATION: 0.45,
    ENTRANCE_TURNS: 1.15,
    ENTRANCE_ORIGIN: Math.PI,
    EXIT_END: 0.55,
    RESPONSE: 4,
    ENTRANCE_RESPONSE: 14,
  },
  monitor: {
    PRESS_DEPTH: 0.0015,
    ACTIVE_EMISSION: 0.18,
    KNOB_ANGLE: Math.PI * 0.75,
    DRAG_PIXELS: 180,
    RESPONSE: 32,
    POWER_OFF_SECONDS: 0.35,
    POWER_ON_SECONDS: 0.48,
    UNDERSCAN_SCALE: 0.97,
    BIAS_RANGE: 0.15,
    GAIN_RANGE: 0.5,
    DOUBLE_TAP_MS: 300,
    TAP_SLOP: 8,
    APERTURE_STRENGTH: 0.45,
    COMPONENT_BLEED: 0.06,
    PHASE_RANGE: 0.45,
    CHROMA_RANGE: 0.95,
    CONTRAST_RANGE: 0.8,
    BRIGHTNESS_LIFT: 0.25,
    BRIGHTNESS_DIM: 0.95,
    NO_SIGNAL_FLOOR: 0.012,
    NO_SIGNAL_NOISE: 0.055,
    NO_SIGNAL_HZ: 24,
    SYNC_ROLL_SPEED: 0.12,
    SYNC_DRIFT: 0.004,
    SYNC_JUMP: 0.008,
    HV_HORIZONTAL_SHIFT: -0.12,
    HV_HORIZONTAL_BLANK: 0.08,
    HV_VERTICAL_BLANK: 0.055,
    PLAYSTATION_SOURCE_ASPECT: 3 / 2,
    PLAYSTATION_CLIPS: [
      "/media/workstation/ps1-generations/generation-01.mp4",
      "/media/workstation/ps1-generations/generation-02.mp4",
      "/media/workstation/ps1-generations/generation-03.mp4",
      "/media/workstation/ps1-generations/generation-04.mp4",
      "/media/workstation/ps1-generations/generation-05.mp4",
      "/media/workstation/ps1-generations/generation-06.mp4",
      "/media/workstation/ps1-generations/generation-07.mp4",
      "/media/workstation/ps1-generations/generation-08.mp4",
      "/media/workstation/ps1-generations/generation-09.mp4",
      "/media/workstation/ps1-generations/generation-10.mp4",
      "/media/workstation/ps1-generations/generation-11.mp4",
    ],
  },
  responsiveScene: {
  ...
  pointerCamera: {
    ENABLED: true,
    SENSITIVITY: 0.11,
    HORIZONTAL_STRENGTH: 0.18,
    VERTICAL_STRENGTH: 0.06,
    FOCUS_DEPTH: 0.5,
    REFERENCE_FOV: 26.5,
    REFERENCE_ASPECT: 1920 / 968,
    POINTER_CLAMP: 1,
    DEADZONE: 0,
    SMOOTH_TIME: 1,
    RETURN_DURATION: 3,
    REENTRY_DURATION: 1.5,
    REENTRY_SPEED: 0.5,
    REVEAL_START: 0.7,
    REVEAL_FULL: 0.95,
  ...
  workstation: {
    ...
    KEYBOARD_POSITION: { x: 0.055, y: 0, z: 0.02 },
    KEYBOARD_ROTATION: { x: 0, y: -2, z: 0 },
    KEYBOARD_SCALE: 1,
    DESK_POSITION: { x: 0.3, y: 0, z: -0.29 },
    DESK_SCALE: { x: 2, y: 1.6, z: 0.91 },
    MONITOR_POSITION: { x: 0.055, y: 0, z: -0.225 },
    MONITOR_YAW: -6,
    ...
    CONTROLLER_POSITION: { x: -0.32, y: 0, z: -0.04 },
    LAMP_SCALE: 0.78,
    LAMP_POSITION: { x: -0.255, y: 0, z: -0.23 },
    WINDOW_POSITION: { x: -0.96, y: 0.8, z: -0.69 },
    WINDOW_SIZE: { x: 0.86, y: 0.95, z: 0.08 },
    ARTWORK_PORTRAIT_URL: "/media/workstation/artwork-portrait.webp",
    ARTWORK_RONALDO_URL: "/media/workstation/artwork-ronaldo.webp",
    ARTWORK_PORTRAIT_POSITION: { x: 0.77, y: 0.72, z: -0.692 },
    ARTWORK_RONALDO_POSITION: { x: 1.06, y: 0.4, z: -0.692 },
    ARTWORK_PORTRAIT_SIZE: { x: 0.3, y: 0.44 },
    ARTWORK_RONALDO_SIZE: { x: 0.28, y: 0.4 },
    ARTWORK_ROTATION: { portrait: 2.5, ronaldo: -2 },
    SKATEBOARD_POSITION: { x: 0.17, y: 0.69, z: -0.59 },
    ...
    FEATURED_RECORD_LEAN: 8,
    RECORD_THICKNESS: 0.006,
    RECORD_SIZE: 0.315,
    SILL_BOOKS_POSITION: { x: -0.76, y: 0.34, z: -0.6 },
    CAMERA_CURVE: { x: 0.035, y: 0.05, z: 0.1 },
    CAMERA_ARC_START: 0.18,
    CAMERA_MAX_ZOOM_OUT: 0.56,
    CAMERA_NARROW_WIDTH: 0.72,
    PROXY_YAW: { mouse: -5, controller: 17, skateboard: -90 },
    LIGHT_WINDOW_OFFSET_Z: 0.6,
    LIGHT_LAMP_OFFSET: { x: -0.03, y: 0.435, z: 0.05 },
    LIGHT_LAMP_POWER_MULT: 0.45,
    LIGHT_NIGHT_FILL_MULT: 0.3,
    LIGHT_NIGHT_WINDOW_MULT: 0.08,
    LIGHT_DAY_LAMP_MULT: 0.025,
    LIGHTING_MODE: "night" as "day" | "night",
    WINDOW_LIGHT: 1.4,
    LAMP_LIGHT: 2.8,
    FILL_LIGHT: 0.35,
    WALL_SIZE: { x: 10, y: 4, z: 0.12 },
    RIGHT_WALL_X: 1.25,
    RIGHT_WALL_DEPTH: 3,
    RIGHT_WALL_COLOR: "#96998c",
    WALL_CENTER_Y: 0.8,
    WALL_COLOR: "#35383d",
    WALL_ROUGHNESS: 0.92,
    WORKSTATION_CAMERA_Y: -0.075,
    CONTACT_SHADOW_OPACITY: 0.72,
    CONTACT_SHADOW_BLUR: 2.5,
    CONTACT_SHADOW_RESOLUTION: 512,
    CONTACT_SHADOW_FAR: 0.6,
    CONTACT_SHADOW_OFFSET: 0.0002,
    CONTACT_SHADOW_REVEAL: 0.45,
    ...
    CRT_TARGET_BALANCED_MAX_SIZE: 1536,
    CRT_TARGET_LOW_MAX_SIZE: 1024,
    CRT_TARGET_MIN_SIZE: 384,
    CRT_TARGET_PROJECTED_SCALE: 1.25,
    TARGET_RESIZE_THRESHOLD: 0.25,
    PAGE_TARGET_HIGH_MAX_SIZE: 2048,
    PAGE_TARGET_BALANCED_MAX_SIZE: 1536,
    PAGE_TARGET_LOW_MAX_SIZE: 1024,
  ...
  model: {
    ...
    PARTICLE_MIN_INTERACTION_SCALE: 0.001,
    ...
    FRAGMENTS: {
      ...
      DEPTH_RATIO: 0.28,
      SPIN: 1.2,
      SEAM_CLOSED_DISTANCE: 0.02,
      SEAM_OPEN_DISTANCE: 0.3,
      INTERIOR_REVEAL: 0.02,
      ENTRANCE_MOMENTUM: 9,
      ENTRANCE_DURATION: 1.2,
      ENTRANCE_EASE: "power3.out",
      ENTRANCE_MAX_SCALE_SPEED: 8,
      ENTRANCE_MAX_FRAME_DELTA: 0.1,
    },
    PARTICLE_COUNT: 16384,
    PARTICLE_COUNT_LOW: 4096,
    PARTICLE_COUNT_MIN: 256,
    PARTICLE_COUNT_MAX: 65536,
    PARTICLE_SIZE_MIN: 0.1,
    PARTICLE_SIZE_MAX: 6,
    PARTICLE_RADIUS: 0.007,
    PARTICLE_RADIUS_LOW: 0.011,
    PARTICLE_CURSOR_RADIUS: 0.5,
    PARTICLE_CURSOR_STRENGTH: 24,
    PARTICLE_REPULSION: 5,
    PARTICLE_RETURN_STRENGTH: 32,
    PARTICLE_DAMPING: 7,
    PARTICLE_MAX_CURSOR_SPEED: 12,
    PARTICLE_HEAT_GAIN: 0.16,
    PARTICLE_HEAT_DECAY: 2.5,
    PARTICLE_TIME_STEP: 1 / 120,
    PARTICLE_MAX_DELTA: 1 / 30,
    PARTICLE_COLOR: "#b2b9c4",
    PARTICLE_HOT_COLOR: "#ff7744",
    BASE_MODEL_Y: 0.1,
