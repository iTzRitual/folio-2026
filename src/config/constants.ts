...
export const CONFIG = {
    ...
    phase2: {
        ...
        RETURN_BRIDGE_TRIGGER_EPSILON: 0.002,
        RETURN_BRIDGE_CAMERA_HOLD_EXIT: 0.84,
        RETURN_BRIDGE_APP_GENIE_START: 0.72,
        RETURN_BRIDGE_APP_GENIE_END: 0.8,
        RETURN_BRIDGE_SAFARI_DIRECT_START: 0.78,
        RETURN_BRIDGE_SAFARI_GENIE_END: 0.9,
