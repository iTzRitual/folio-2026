...
export const CONFIG = {
    ...
    phase2: {
        ...
        MOBILE_BROWSER_ASPECT: 1.65,
        MOBILE_DEVTOOLS_HEIGHT_MULT: 0.14,
        MOBILE_DEVICE_HEIGHT_MULT: 0.82,
        MOBILE_DEVICE_WIDTH_MULT: 0.3,
        MOBILE_DEVICE_FRAME_PADDING_MULT: 0.012,
        MOBILE_DEVTOOLS_BACKGROUND_COLOR: "#eaf0fb",
        MOBILE_DEVTOOLS_BORDER_COLOR: "#c9d7ed",
        MOBILE_DEVTOOLS_TEXT_COLOR: "#4c5563",
        MOBILE_DEVTOOLS_MUTED_COLOR: "#7b8797",
        MOBILE_DEVTOOLS_RULER_COLOR: "#c1d5f3",
        MOBILE_DEVICE_FRAME_COLOR: "#1b1b1b",
        MOBILE_DEVTOOLS_DEVICE_LABEL: "iPhone 14 Pro",
        MOBILE_DEVTOOLS_ZOOM_LABEL: "100%",
        ...
        RETURN_BRIDGE_REVEAL_BREAKPOINT: 0.16,
        RETURN_BRIDGE_APP_DURATION: 0.48,
        RETURN_BRIDGE_SAFARI_DURATION: 0.52,
        RETURN_BRIDGE_REDUCED_DURATION: 0.16,
